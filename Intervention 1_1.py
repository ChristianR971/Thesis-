...
plt.title("Int 1: Delta CO2 of the EU")
plt.xlabel("Sectors")
...
plt.title("Int 1: Delta CO2 of the Rest of the World")
plt.xlabel("index")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 1: Delta employment of the EU")
plt.xlabel("Sectors")
...
plt.title("Int 1: Delta employment of the Rest of the World")
plt.xlabel("Sectors")
...
plt.title("Int 1: Delta Value Added of the EU")
plt.xlabel("Sectors")
...
plt.title("Int 1: Delta Value Added of the RoW")
plt.xlabel("Sectors")
plt.ylabel("Value Added difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 2: Delta CO2 of the EU")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 2: Delta CO2 of the Rest of the World")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 2: Delta employment of the EU")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 2: Delta employment of the Rest of the World")
plt.xlabel("Sectors")
...
plt.title("Int 2: Delta Value Added of the EU")
plt.xlabel("Sectors")
plt.ylabel("Value Added difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 2: Delta Value Added of the RoW")
plt.xlabel("Sectors")
plt.ylabel("Value Added difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta CO2 of the EU")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta CO2 of the Rest of the World")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta employment of the EU")
plt.xlabel("Sectors")
plt.ylabel("CO2 difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta employment of the Rest of the World")
plt.xlabel("Sectors")
plt.ylabel("Employment difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta Value Added of the EU")
plt.xlabel("Sectors")
plt.ylabel("Value Added difference with the baseline")
plt.grid(True)
plt.show()
...
plt.title("Int 3: Delta Value Added of the RoW")
plt.xlabel("Sectors")
plt.ylabel("Value Added difference with the baseline")
plt.grid(True)
plt.show()
...
delta_first3_E_EU = [delta_E_s1_EU, delta_E_s2_EU, delta_E_s3_EU]
delta_EU = sum(delta_first3_E_EU).sort_values(ascending=True)
delta_EU

delta_EU.plot(kind='bar', color= 'red')
plt.figure(figsize=(10,6))
plt.show()

#%%
delta_first3_E_RoW = [delta_E_s1_RoW, delta_E_s2_RoW, delta_E_s3_RoW]
delta_RoW = sum(delta_first3_E_RoW).sort_values(ascending=False)
delta_RoW

delta_RoW.plot(kind='bar', color='blue')
plt.title(" Int 1,2,3: Delta CO2 of the RoW")
plt.show()

#%%
delta_first3_Emp_RoW = [delta_Emp_1_RoW, delta_Emp_2_RoW, delta_Emp_3_RoW]
delta_RoW = sum(delta_first3_Emp_RoW).sort_values(ascending=False)
delta_RoW

delta_RoW.plot(kind='bar', color='blue')
plt.title("Int 1,2,3: Delta Employment of the RoW")
plt.show()

#%%
delta_first3_VA_RoW = [delta_VA_s1_RoW, delta_VA_s2_RoW, delta_VA_s3_RoW]
delta_RoW = sum(delta_first3_VA_RoW).sort_values(ascending=False)
delta_RoW

delta_RoW.plot(kind='bar', color='blue')
plt.title("Int 1,2,3: Delta Value Added of the RoW")
plt.show()
